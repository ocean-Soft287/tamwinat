              ...
              ? InkWell(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        '${(UserPhone != null) ? listAddressUser.dataAddressList[listAddressUser.SelectIndexAddress]["DistrictName2"] : widget.ValueselectedDistrict}',
                        style: GoogleFonts.cairo(
                              ...
                              if (selectedOption == 0) {
                                return MainConfirmButton(
                                    ...
                                    onTap: () {
                                      ...
                                      print(
                                          'apartment ${widget.titleNotes}'); //  listItemOrder.clearItems();
                                    });
