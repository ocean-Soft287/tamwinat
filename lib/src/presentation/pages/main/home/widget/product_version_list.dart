...
class _ProductVersionListState extends ConsumerState<ProductVersionList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ref, child) {
      ...
      return (getDataProductVersiontFromApi.productVersionList.isEmpty ||
              getDataProductVersiontFromApi.productVersionList[0]
                      ["ShowGroup"] ==
                  0)
          ? const SizedBox()
          : Column(
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = getDataProductVersiontFromApi
                          .productVersionList[index];
                      num q1 =
                          listItemOrder.getQuantity(itemID: item['BarCode']);
                      num y =
                          listItemOrder.getYGiftQty(itemID: item["BarCode"]);
                      return Card(
                        color: Colors.white,
                        child: Container(
                          color: Colors.white,
                                                                    ...
                                                                    if (item[
                                                                      ...
                                                                      if (q1 <
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          if (item['GiftQTY'] > 0 &&
                                                                              item['RequiredQTY'] > 0) {
                                                                            if ((q1 - item['GiftQTY'] * item["Y_Gift_Qty"]) % item['RequiredQTY'] ==
                                                                                0) {
                                                                              q1 += item['GiftQTY'];
                                                                              item["Y_Gift_Qty"]++;
  ...
  num addItemToCart(int index, num q1, ListItemOrder listItemOrder,
    ...
    setState(() {
      widget.isSecondContainerProductVersion[index] =
          !widget.isSecondContainerProductVersion[index];
    ...
    if (widget.isSecondContainerProductVersion[index]) {
      Future.delayed(const Duration(milliseconds: 10000), () {
        setState(() {
          widget.isSecondContainerProductVersion[index] = false;
        });
      });
    }
