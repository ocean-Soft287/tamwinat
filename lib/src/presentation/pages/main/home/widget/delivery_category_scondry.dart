...
class _DeliveryCategoryScondoryState extends ConsumerState<DeliveryCategoryScondory>
  ...
  void _showStockLimitSnackBar(
      {required AppModel appModel, required num stockQty}) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: categoryProvider.categoryByParentIdList.isEmpty
            ? SizedBox(height: 34.r, child: loadingMethod())
            : Column(
                children: [
                  10.verticalSpace,
                      ...
                      child: Column(children: [
                        Consumer(
                          builder: (context, ref, child) {
                            ...
                            bool isSelectedAll = categoryProvider.isSelectedAll(
                                                                      ...
                                                                      builder:
                                                                          (context) =>
                                                                              BannerDetailsPage(
                                                                                ...
                                                                                name: (appModel.activeLanguage.languageCode == 'ar') ? item['ProductArName'] : item['ProductEnName'],
                                                                      ...
                                                                      children: [
                                                                                      ...
                                                                                      if ((UserPhoneAll ?? UserPhone) == null) {
                                                                                              ...
                                                                                              actions: [
                                                                                                Form(
                                                                                                  ...
                                                                                                  child: MyStyledTextField(
                                                                                                    ...
                                                                                                    validator: (value) {
                                                                                                      if (value!.isEmpty) {
                                                                                                        return (appModel.activeLanguage.languageCode == 'ar') ? 'هذا الحقل مطلوب' : 'This field is required';
                                                                                                      } else if (value.length != 8 || !(value.startsWith('4') || value.startsWith('5') || value.startsWith('6') || value.startsWith('9'))) {
                                                                                                        return (appModel.activeLanguage.languageCode == 'ar') ? '  رقم الهاتف غير صحيح او الارقام لا تحتوي علي ارقام انجليزية يرجي التأكد   ا' : 'The Mobile Number not correct please check the mobile number';
                                                                                                      } else {
                                                                                                        return null;
                                                                                                      }
                                                                                                    },
                                                                                        ...
                                                                                        setState(() {
                                                                                          ...
                                                                                          listItemOrderImage.addItem({
                                                                                            ...
                                                                                            "StockQuantity": item["StockQuantity"],
                                                                                            "CustomerQuantity": (item["CustomerQuantity"] > 0.0) ? item["CustomerQuantity"] : item["CustomerQtyFree"],
                                                                                            "BarCode": item["BarCode"],
                                                                                            "Colors_ID": '',
                                                                                            "Size_ID": '',
                                                                                            "RequiredQTY": item['RequiredQTY'],
                                                                                              ...
                                                                                              children: [
                                                                                                      ...
                                                                                                      if (item["CustomerQuantity"] >= item["StockQuantity"]) {
                                                                                                        ...
                                                                                                        if (q1 < item["CustomerQuantity"]) {
                                                                                                          ...
                                                                                                          listItemOrder.addItem({
                                                                                                            ...
                                                                                                            "Quantity": q1,
                                                                                                            "Price": item["PriceAfterDiscount"],
                                                                                                            "StockQuantity": item["CustomerQuantity"],
                                                                                                            "BarCode": item["BarCode"],
                                                                                                            "Colors_ID": '',
                                                                                                            "Size_ID": '',
                                                                                                            "RequiredQTY": item['RequiredQTY'],
                                                                                                      ...
                                                                                                      if (item["CustomerQtyFree"] >= item["StockQuantity"]) {
                                                                                                        ...
                                                                                                        if (q1 < item["CustomerQtyFree"]) {
                                                                                                          ...
                                                                                                          listItemOrder.addItem({
                                                                                                            ...
                                                                                                            "Quantity": q1,
                                                                                                            "Price": item["PriceAfterDiscount"],
                                                                                                            "StockQuantity": item["CustomerQtyFree"],
                                                                                                            "BarCode": item["BarCode"],
                                                                                                            "Colors_ID": '',
                                                                                                            "Size_ID": '',
                                                                                                            "RequiredQTY": item['RequiredQTY'],
                                                                                                          ...
                                                                                                          listItemOrderImage.addItem({
                                                                                                            ...
                                                                                                            "ProductEnName": item["ProductEnName"] + ' * ' + item['UnitValue'].toString(),
                                                                                                            "StockQuantity": item["CustomerQtyFree"],
                                                                                                            "CustomerQuantity": item["CustomerQtyFree"],
                                                                                                            "BarCode": item["BarCode"],
                                                                                                            "Colors_ID": '',
                                                                                                            "Size_ID": '',
                                                                                                            "RequiredQTY": item['RequiredQTY'],
                                                                                                ...
                                                                                                TextButton(
                                                                                                  onPressed: () {
                                                                                                    ...
                                                                                                    if (q1 == 0) {}
                                                                                                    listItemOrder.decreaseQuantity(item["BarCode"]);
                                                                                                    listItemOrderImage.decreaseQuantity(item["BarCode"]);
                                                                                                  },
                                                                                                  child: Text(
                                                                                                    '-',
                                                                                                    style: TextStyle(
                                                                        ...
                                                                        (item["DiscountPercent"] ==
                                                                            ...
                                                                            ? Row(
                                                                                children: [
                                                                                  ...
                                                                                  Text(
                                                                                    (appModel.activeLanguage.languageCode == 'ar') ? 'د.ك' : 'K.D',
                                                                                    style: TextStyle(
                                                                                      fontSize: 14.sp,
                                                                                      fontWeight: FontWeight.bold,
                                                                                      fontFamily: 'Monadi',
                                                                        ...
                                                                        Text(
                                                                          (_remainingStock(item, q1) == 0)
                                                                              ? ((appModel.activeLanguage.languageCode == 'ar') ? 'تم نفاذ الكمية' : 'Out of stock')
                                                                              : ((appModel.activeLanguage.languageCode == 'ar') ? 'المخزون المتبقي: ${_remainingStock(item, q1)}' : 'Remaining stock: ${_remainingStock(item, q1)}'),
                                                                          style:
                                                                              GoogleFonts.tajawal(
                                                                            fontSize:
                                                                                11.sp,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (item["IsFavorite"] ==
                                                                            ...
                                                                            deletFavorite.DeleteItemFavoritePost(ProductId: item["ProductID"].toString());
                                                                          }
                                                                          setState(
                                                                              () {
                                      ...
                                      builder: (context, ref, child) {
                                        ...
                                        return Padding(
                                          padding: REdgeInsets.only(
                                              bottom: 50.0, right: 4, left: 4),
                                          child:
                                              isLoading3 // isLoading2 || isLoading3
                                                  ? const GridListShimmer(
                                                      itemCount: 10,
                                                      isScrollable: true,
                                                      onlyBottomPadding: 10,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Expanded(
                                                                              flex: 2,
                                                                              child: Text(
                                                                                (appModel.activeLanguage.languageCode == 'ar') ? '${item["ProductArName"]} * ${item['UnitValue'].toString()}' : '${item["ProductEnName"]} * ${item['UnitValue'].toString()}',
                                                                                maxLines: 2,
                                                                                style: TextStyle(
                                                                                  fontSize: 13.sp,
                                                                                  fontWeight: FontWeight.w500,
                                                                      ...
                                                                      Positioned(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            icon:
                                                                                Icon(
                                                                              Icons.favorite,
                                                                              color: item["IsFavorite"] == 1 ? Colors.red : const Color.fromRGBO(200, 200, 200, 1.0),
                                                                            ),
                                                                            onPressed:
                                                                                () {
          ...
          actions: [
            Form(
              ...
              child: MyStyledTextField(
                maxLength: 8,
                keyboardType: TextInputType.phone,
                label: (appModel.activeLanguage.languageCode == 'ar')
                    ? 'رقم الموبيل'
                    : 'Mobial Number',
  ...
  String? mobilePhoenValidation(AppModel appModel, String? value) {
    ...
    final isValidPrefix = value.startsWith('4') ||
        value.startsWith('5') ||
        value.startsWith('6') ||
        value.startsWith('9');
  ...
  HorizontalListShimmer loadingMethod() {
