...
class _$_MainState extends _MainState {
  const _$_MainState({this.isSearching = false, this.query = ''}) : super._();
  ...
  @override
  String toString() {
    return 'MainState(isSearching: $isSearching, query: $query)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isSearching, query);
...
abstract class _MainState extends MainState {
  const factory _MainState({final bool isSearching, final String query}) =
      _$_MainState;
